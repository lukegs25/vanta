...
module.exports = function ($$$config) {
  ...
  function resolveClassComponentProps(Component, baseProps) {
    ...
    if ((Component = Component.defaultProps)) {
      ...
      for (var propName$42 in Component)
        void 0 === newProps[propName$42] &&
          (newProps[propName$42] = Component[propName$42]);
    }
    return newProps;
  }
  ...
  function appendAllChildren(
    ...
    if (supportsMutation)
      ...
      for (var node$78 = workInProgress.child; null !== node$78; ) {
        if (5 === node$78.tag) {
          var instance = node$78.stateNode;
          needsVisibilityToggle &&
            isHidden &&
            (instance = cloneHiddenInstance(
              instance,
              node$78.type,
              node$78.memoizedProps
            ));
          appendInitialChild(parent, instance);
        } else if (6 === node$78.tag)
          (instance = node$78.stateNode),
            needsVisibilityToggle &&
              isHidden &&
            ...
            appendInitialChild(parent, instance);
        else if (4 !== node$78.tag)
          if (22 === node$78.tag && null !== node$78.memoizedState)
            (instance = node$78.child),
              null !== instance && (instance.return = node$78),
              appendAllChildren(parent, node$78, !0, !0);
          else if (null !== node$78.child) {
            node$78.child.return = node$78;
            node$78 = node$78.child;
            continue;
          }
        if (node$78 === workInProgress) break;
        for (; null === node$78.sibling; ) {
          if (null === node$78.return || node$78.return === workInProgress)
            return;
          node$78 = node$78.return;
        }
        node$78.sibling.return = node$78.return;
        node$78 = node$78.sibling;
      }
  }
      ...
      if (
        ...
        oldProps$81 === currentInstance
          ...
          : (finalizeInitialChildren(
            ...
            (workInProgress.stateNode = oldProps$81),
            current
              ? appendAllChildren(oldProps$81, workInProgress, !1, !1)
              : markUpdate(workInProgress));
    ...
    if (!isHydrating)
      switch (renderState.tailMode) {
        ...
        case "collapsed":
          ...
          for (var lastTailNode$83 = null; null !== lastTailNode; )
            null !== lastTailNode.alternate && (lastTailNode$83 = lastTailNode),
              (lastTailNode = lastTailNode.sibling);
          null === lastTailNode$83
            ? hasRenderedATailFallback || null === renderState.tail
              ? (renderState.tail = null)
              : (renderState.tail.sibling = null)
            : (lastTailNode$83.sibling = null);
      }
  }
      ...
      if (0 !== (completedWork.mode & 2)) {
        for (
          ...
          (newChildLanes |= child$86.lanes | child$86.childLanes),
            (subtreeFlags |= child$86.subtreeFlags & 31457280),
            (subtreeFlags |= child$86.flags & 31457280),
        ...
        for (
          ...
          (newChildLanes |=
            ...
            (subtreeFlags |= treeBaseDuration$85.subtreeFlags & 31457280),
            (subtreeFlags |= treeBaseDuration$85.flags & 31457280),
          ...
          a: if (((current = null), supportsMutation))
            for (root = finishedWork; ; ) {
              if (
                ...
                if (null === current)
                  try {
                    var instance$124 = root.stateNode;
                    hoistableRoot
                      ? hideTextInstance(instance$124)
                      : unhideTextInstance(instance$124, root.memoizedProps);
                  } catch (error$125) {
                    captureCommitPhaseError(
                      finishedWork,
                      finishedWork.return,
